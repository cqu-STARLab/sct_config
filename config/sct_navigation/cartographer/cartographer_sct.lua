...
map_frame = os.getenv("map_frame") or "map"
odom_frame = os.getenv("odom_frame") or "odom"
base_frame = os.getenv("base_frame") or "base_link"
...
options = {
  ...
  publish_to_tf = true,
  -- 也不让他发 map->odom_frame
  publish_frame_projected_to_2d = false, 
  -- 可以彻底关闭 odom->base_link
